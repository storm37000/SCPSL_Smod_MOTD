...
namespace MOTD
{
	...
	class Main : Plugin
	{
		...
		public override void Register()
		{
			...
			this.AddConfig(new Smod2.Config.ConfigSetting("motd_messages", new Dictionary<string,string>(), Smod2.Config.SettingType.DICTIONARY, true, "List of messages one line at a time."));
